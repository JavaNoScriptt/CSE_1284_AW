...
#
# Some folks had difficulty with division operators, module functions,
# and type conversion on quiz 2. This very short exercise is extra practice
# to help you gain proficiency in these topics.
# 
# If you got 10/10 on quiz 2, this exercise is optional for you.
# I will give you 10/10 on this exercise if you had 10/10 on the quiz.
# I recommend everyone do the exercise anyway because practice is good!
#
# IMPORTANT! You are only allowed to change one line per problem.
#            It must be the line I indicated should be changed.
#
#
# Deliverables
#    ex_week2_extra_NETID.py - your code file
#    ex_week2_extra_NETID.png or jpg - your screenshot
